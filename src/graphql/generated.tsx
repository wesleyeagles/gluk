...
export type Category = Node & {
  ...
  id: Scalars['ID'];
  name: Scalars['String'];
  products: Array<CategoryCategory>;
  /** The time the document was published. Null on documents in draft stage. */
  publishedAt?: Maybe<Scalars['DateTime']>;
  /** User that last published this document */
  publishedBy?: Maybe<User>;
...
export type CategoryCategory = Product;

export type CategoryCategoryConnectInput = {
  Product?: InputMaybe<ProductConnectInput>;
};

export type CategoryCategoryCreateInput = {
  Product?: InputMaybe<ProductCreateInput>;
};

export type CategoryCategoryCreateManyInlineInput = {
  /** Connect multiple existing CategoryCategory documents */
  connect?: InputMaybe<Array<CategoryCategoryWhereUniqueInput>>;
  /** Create and connect multiple existing CategoryCategory documents */
  create?: InputMaybe<Array<CategoryCategoryCreateInput>>;
};

export type CategoryCategoryCreateOneInlineInput = {
  /** Connect one existing CategoryCategory document */
  connect?: InputMaybe<CategoryCategoryWhereUniqueInput>;
  /** Create and connect one CategoryCategory document */
  create?: InputMaybe<CategoryCategoryCreateInput>;
};

export type CategoryCategoryUpdateInput = {
  Product?: InputMaybe<ProductUpdateInput>;
};

export type CategoryCategoryUpdateManyInlineInput = {
  /** Connect multiple existing CategoryCategory documents */
  connect?: InputMaybe<Array<CategoryCategoryConnectInput>>;
  /** Create and connect multiple CategoryCategory documents */
  create?: InputMaybe<Array<CategoryCategoryCreateInput>>;
  /** Delete multiple CategoryCategory documents */
  delete?: InputMaybe<Array<CategoryCategoryWhereUniqueInput>>;
  /** Disconnect multiple CategoryCategory documents */
  disconnect?: InputMaybe<Array<CategoryCategoryWhereUniqueInput>>;
  /** Override currently-connected documents with multiple existing CategoryCategory documents */
  set?: InputMaybe<Array<CategoryCategoryWhereUniqueInput>>;
  /** Update multiple CategoryCategory documents */
  update?: InputMaybe<Array<CategoryCategoryUpdateWithNestedWhereUniqueInput>>;
  /** Upsert multiple CategoryCategory documents */
  upsert?: InputMaybe<Array<CategoryCategoryUpsertWithNestedWhereUniqueInput>>;
};

export type CategoryCategoryUpdateManyWithNestedWhereInput = {
  Product?: InputMaybe<ProductUpdateManyWithNestedWhereInput>;
};

export type CategoryCategoryUpdateOneInlineInput = {
  /** Connect existing CategoryCategory document */
  connect?: InputMaybe<CategoryCategoryWhereUniqueInput>;
  /** Create and connect one CategoryCategory document */
  create?: InputMaybe<CategoryCategoryCreateInput>;
  /** Delete currently connected CategoryCategory document */
  delete?: InputMaybe<Scalars['Boolean']>;
  /** Disconnect currently connected CategoryCategory document */
  disconnect?: InputMaybe<Scalars['Boolean']>;
  /** Update single CategoryCategory document */
  update?: InputMaybe<CategoryCategoryUpdateWithNestedWhereUniqueInput>;
  /** Upsert single CategoryCategory document */
  upsert?: InputMaybe<CategoryCategoryUpsertWithNestedWhereUniqueInput>;
};

export type CategoryCategoryUpdateWithNestedWhereUniqueInput = {
  Product?: InputMaybe<ProductUpdateWithNestedWhereUniqueInput>;
};

export type CategoryCategoryUpsertWithNestedWhereUniqueInput = {
  Product?: InputMaybe<ProductUpsertWithNestedWhereUniqueInput>;
};

export type CategoryCategoryWhereInput = {
  Product?: InputMaybe<ProductWhereInput>;
};

export type CategoryCategoryWhereUniqueInput = {
...
export type CategoryCreateInput = {
  createdAt?: InputMaybe<Scalars['DateTime']>;
  name: Scalars['String'];
  products?: InputMaybe<CategoryCategoryCreateManyInlineInput>;
  slug: Scalars['String'];
  updatedAt?: InputMaybe<Scalars['DateTime']>;
};
...
export type CategoryUpdateInput = {
  name?: InputMaybe<Scalars['String']>;
  products?: InputMaybe<CategoryCategoryUpdateManyInlineInput>;
  slug?: InputMaybe<Scalars['String']>;
};
...
export type ProductCreateInput = {
  ...
  cl92wvly13f5a01tcc64i4qo3?: InputMaybe<ClientCreateManyInlineInput>;
  cl95miee966kc01uk9pdq05c4?: InputMaybe<ShopCreateManyInlineInput>;
  createdAt?: InputMaybe<Scalars['DateTime']>;
  inventory: Scalars['Int'];
  name: Scalars['String'];
  price: Scalars['Float'];
...
export type ProductManyWhereInput = {
  ...
  /** All values greater than the given value. */
  inventory_gt?: InputMaybe<Scalars['Int']>;
  /** All values greater than or equal the given value. */
  inventory_gte?: InputMaybe<Scalars['Int']>;
  /** All values that are contained in given list. */
  inventory_in?: InputMaybe<Array<InputMaybe<Scalars['Int']>>>;
  /** All values less than the given value. */
  inventory_lt?: InputMaybe<Scalars['Int']>;
  /** All values less than or equal the given value. */
  inventory_lte?: InputMaybe<Scalars['Int']>;
  /** All values that are not equal to given value. */
  inventory_not?: InputMaybe<Scalars['Int']>;
  /** All values that are not contained in given list. */
  inventory_not_in?: InputMaybe<Array<InputMaybe<Scalars['Int']>>>;
  name?: InputMaybe<Scalars['String']>;
  /** All values containing the given string. */
  name_contains?: InputMaybe<Scalars['String']>;
  /** All values ending with the given string. */
...
export type ProductUpdateInput = {
  ...
  cl92wvly13f5a01tcc64i4qo3?: InputMaybe<ClientUpdateManyInlineInput>;
  cl95miee966kc01uk9pdq05c4?: InputMaybe<ShopUpdateManyInlineInput>;
  inventory?: InputMaybe<Scalars['Int']>;
  name?: InputMaybe<Scalars['String']>;
  price?: InputMaybe<Scalars['Float']>;
  slug?: InputMaybe<Scalars['String']>;
...
export type ScheduledOperationAffectedDocument = Asset | Category | Client | Product | Shop;
...
export type CreateCategoryMutation = { __typename?: 'Mutation', createCategory?: { __typename?: 'Category', id: string } | null, publishCategory?: { __typename?: 'Category', id: string } | null };
...
export type CreateClientMutation = { __typename?: 'Mutation', createClient?: { __typename?: 'Client', id: string } | null, publishClient?: { __typename?: 'Client', id: string } | null };
...
export type CreateProductMutation = { __typename?: 'Mutation', createProduct?: { __typename?: 'Product', id: string, name: string } | null, publishProduct?: { __typename?: 'Product', id: string } | null };

export type CreateShopMutationVariables = Exact<{
  email: Scalars['String'];
  total: Scalars['Float'];
  products?: InputMaybe<Array<ProductWhereUniqueInput> | ProductWhereUniqueInput>;
}>;


export type CreateShopMutation = { __typename?: 'Mutation', createShop?: { __typename?: 'Shop', id: string } | null, publishShop?: { __typename?: 'Shop', id: string } | null };
...
export type DeleteClientMutation = { __typename?: 'Mutation', deleteClient?: { __typename?: 'Client', id: string } | null };
...
export type EditClientMutation = { __typename?: 'Mutation', updateClient?: { __typename?: 'Client', id: string } | null, publishClient?: { __typename?: 'Client', id: string } | null };
...
export type EditProductMutation = { __typename?: 'Mutation', updateProduct?: { __typename?: 'Product', id: string } | null, publishProduct?: { __typename?: 'Product', id: string } | null };

export type CategoriesQueryVariables = Exact<{ [key: string]: never; }>;


export type CategoriesQuery = { __typename?: 'Query', categories: Array<{ __typename?: 'Category', createdAt: any, name: string, id: string, slug: string, products: Array<{ __typename?: 'Product', id: string, name: string }> }> };

export type CategoryByNameQueryVariables = Exact<{
  name?: InputMaybe<Scalars['String']>;
}>;


export type CategoryByNameQuery = { __typename?: 'Query', category?: { __typename?: 'Category', id: string, name: string, products: Array<{ __typename?: 'Product', id: string, name: string, price: number, inventory: number, createdAt: any, slug?: string | null }> } | null };
...
export type ClientByIdQuery = { __typename?: 'Query', client?: { __typename?: 'Client', id: string, name: string, email: string, phone: string, adress: string, slug: string } | null };

export type ClientsQueryVariables = Exact<{ [key: string]: never; }>;


export type ClientsQuery = { __typename?: 'Query', clients: Array<{ __typename?: 'Client', id: string, createdAt: any, email: string, name: string, phone: string, slug: string, adress: string, shops: Array<{ __typename?: 'Shop', id: string, total?: number | null, products: Array<{ __typename?: 'Product', id: string, name: string }> }> }> };
...
export type ProductBySlugQuery = { __typename?: 'Query', product?: { __typename?: 'Product', id: string, inventory: number, name: string, price: number, slug?: string | null, categories: Array<{ __typename?: 'Category', name: string }> } | null };

export type ProductsQueryVariables = Exact<{ [key: string]: never; }>;


export type ProductsQuery = { __typename?: 'Query', products: Array<{ __typename?: 'Product', id: string, name: string, inventory: number, price: number, slug?: string | null, categories: Array<{ __typename?: 'Category', name: string }> }> };

export type ShopsQueryVariables = Exact<{ [key: string]: never; }>;


export type ShopsQuery = { __typename?: 'Query', shops: Array<{ __typename?: 'Shop', total?: number | null, createdAt: any, client?: { __typename?: 'Client', name: string } | null, products: Array<{ __typename?: 'Product', name: string }> }> };
...
export const CreateProductDocument = gql`
  ...
  createProduct(
    data: {name: $name, price: $price, inventory: $inventory, slug: $slug, categories: {connect: {name: $categoryName}}}
  ) {
    id
    name
  }
...
export const DeleteCategoryDocument = gql`
  ...
  deleteCategory(where: {name: $name}) {
    id
  }
}
    `;
...
export const EditProductDocument = gql`
  ...
  updateProduct(
    data: {name: $name, price: $price, inventory: $inventory, slug: $productSlug}
    where: {id: $id}
  ) {
    id
  }
...
/**
 * __useCategoryByNameQuery__
 *
 * To run a query within a React component, call `useCategoryByNameQuery` and pass it any options that fit your needs.
 * When your component renders, `useCategoryByNameQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useCategoryByNameQuery({
 *   variables: {
 *      name: // value for 'name'
 *   },
 * });
 */
export function useCategoryByNameQuery(baseOptions?: Apollo.QueryHookOptions<CategoryByNameQuery, CategoryByNameQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<CategoryByNameQuery, CategoryByNameQueryVariables>(CategoryByNameDocument, options);
      }
export function useCategoryByNameLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<CategoryByNameQuery, CategoryByNameQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<CategoryByNameQuery, CategoryByNameQueryVariables>(CategoryByNameDocument, options);
        }
export type CategoryByNameQueryHookResult = ReturnType<typeof useCategoryByNameQuery>;
export type CategoryByNameLazyQueryHookResult = ReturnType<typeof useCategoryByNameLazyQuery>;
export type CategoryByNameQueryResult = Apollo.QueryResult<CategoryByNameQuery, CategoryByNameQueryVariables>;
 ...
 * });
 */
export function useClientByIdQuery(baseOptions: Apollo.QueryHookOptions<ClientByIdQuery, ClientByIdQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<ClientByIdQuery, ClientByIdQueryVariables>(ClientByIdDocument, options);
      }
export function useClientByIdLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<ClientByIdQuery, ClientByIdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<ClientByIdQuery, ClientByIdQueryVariables>(ClientByIdDocument, options);
        }
...
export type ClientByIdQueryResult = Apollo.QueryResult<ClientByIdQuery, ClientByIdQueryVariables>;
...
export const ShopsDocument = gql`
    query Shops {
  shops(first: 3, orderBy: publishedAt_DESC) {
    client {
      name
    }
    products {
